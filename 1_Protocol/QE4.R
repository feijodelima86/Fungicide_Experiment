...
# Examples of how to use the plotting functions directly
# ---------------------------------------------------

# Example 1: Basic treatment plot
# This shows how to create a treatment plot with error bars directly
...
# # Calculate means and standard errors for AI
 mean_AI <- aggregate(AI ~ Treatment + Day, 
                      data = data, 
                      FUN = function(x) c(mean = mean(x, na.rm = TRUE), 
                                          se = sd(x, na.rm = TRUE)/sqrt(sum(!is.na(x)))))
 mean_AI <- do.call(data.frame, mean_AI)
 colnames(mean_AI)[3:4] <- c("mean_AI", "se_AI")
...
#
# # Create the treatment plot
# create_treatment_plot(mean_AI, "mean_AI", "se_AI", "AI", "Autotrophic Index Over Time")
#
#
# # Example 2: Selective treatment plot
# # This shows how to create a plot showing only selected treatments
#
# # First plot: Control 1, 2 and Treatment5 (highest concentration)
# first_plot_treatments <- c("Control1", "Control2", "Treatment5")
# create_treatment_plot_selective(mean_AI, 
#                               "mean_AI", 
#                               "se_AI", 
#                               "AI", 
...
#
#
# # Example 3: Concentration plot
# # This shows how to create a concentration plot
#
# # Map treatments to fungicide concentrations
# fungicide_conc <- c(
#   "Control1" = 0,      # No fungicide
#   "Control2" = 0,      # No fungicide, only acetone
...
# )
#
# # Create some example significant points
# significant_points <- list(
#   list(day = 7, treatment = "Treatment4", concentration = 54, p_value = 0.01),
#   list(day = 10, treatment = "Treatment5", concentration = 540, p_value = 0.005)
# )
#
# # Create the concentration plot
# create_concentration_plot(mean_AI, 
#                          "mean_AI", 
#                          "se_AI", 
#                          "AI", 
#                          "AI by Fungicide Concentration",
#                          fungicide_conc,
#                          significant_points,
#                          treatment_colors,
#                          treatment_pch)
#
#
# # Example 4: Creating all plots at once for a variable
# # This shows how to generate all visualization types for your variable
#
# # Calculate means for an acetone-adjusted variable (if you have one)
# # data$acetone_adjusted_AI <- data$AI - some_adjustment
# # mean_adj_AI <- aggregate(acetone_adjusted_AI ~ Treatment + Day, 
# #                         data = data, 
# #                         FUN = function(x) c(mean = mean(x, na.rm = TRUE), 
# #                                            se = sd(x, na.rm = TRUE)/sqrt(sum(!is.na(x)))))
# # mean_adj_AI <- do.call(data.frame, mean_adj_AI)
# # colnames(mean_adj_AI)[3:4] <- c("mean_adjusted_AI", "se_adjusted_AI")
# # mean_adj_AI$Treatment <- factor(mean_adj_AI$Treatment, 
# #                               levels = c("Control1", "Control2", 
# #                                         "Treatment1", "Treatment2", 
# #                                         "Treatment3", "Treatment4", 
# #                                         "Treatment5"))
...
# # generate_visualizations(mean_AI, 
# #                        mean_adj_AI, 
# #                        "AI", 
# #                        treatment_colors, 
# #                        treatment_pch, 
