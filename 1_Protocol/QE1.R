...
analyze_response_variable <- function(data, response_var, log_transform = FALSE, main_title = "") {
  ...
  generate_visualizations(mean_original, mean_adjusted, response_var, treatment_colors, 
                          treatment_pch, fungicide_conc, main_title)
...
generate_visualizations <- function(mean_original, mean_adjusted, response_var, 
  ...
  # For demonstration, we'll use NULL for significant points
  # In practice, you'd determine this from statistical tests
...
results_AI <- analyze_response_variable(data, "AI", log_transform = FALSE, main_title = "Autotrophic Index")

# To analyze another variable, simply change the variable name:
# results_CP <- analyze_response_variable(data, "C.P.ratio", log_transform = FALSE, main_title = "C/P Ratio")